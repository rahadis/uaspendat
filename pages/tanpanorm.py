...
if save and model=='GaussianNB':
    data = Dataset.tanpanormalisasi([battery_power, clock_speed, fc, int_memory, m_dep, mobile_wt, n_cores, pc, px_height, px_width, ram, sc_h, sc_w, talk_time, blue, dual_sim, four_g, three_g, touch_screen, wifi])
    prediksi = Dataset.NB(data)
    execute(prediksi)
elif save and model=='Random Forest':
    data = Dataset.tanpanormalisasi([battery_power, clock_speed, fc, int_memory, m_dep, mobile_wt, n_cores, pc, px_height, px_width, ram, sc_h, sc_w, talk_time, blue, dual_sim, four_g, three_g, touch_screen, wifi])
    prediksi = Dataset.ranforest(data)
    execute(prediksi)
elif save and model=='Decision Tree':
    data = Dataset.tanpanormalisasi([battery_power, clock_speed, fc, int_memory, m_dep, mobile_wt, n_cores, pc, px_height, px_width, ram, sc_h, sc_w, talk_time, blue, dual_sim, four_g, three_g, touch_screen, wifi])
